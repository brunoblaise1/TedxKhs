        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="relative h-60">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-6">
                <div className="text-white">
                  <h3 className="text-xl font-bold">Theme: What Next?</h3>
                </div>
              </div>
            </div>
            <CardContent className="p-6">
              <div className="flex items-center gap-4 mb-4 text-gray-600">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">November 30th, 2024</span>
                </div>
                <div className="flex items-center gap-2">
                  <MapPin className="h-4 w-4 text-ted-red" />
                  <span className="text-sm">Canal Olympia, Rebero</span>
                </div>
              </div>
              ...
              <Button className="w-full bg-ted-red hover:bg-ted-red/90 text-white">Register Now</Button>
            </CardContent>
          </Card>
          ...
          >
            <div className="relative h-60">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-6">
                <div className="text-white">
                  <h3 className="text-xl font-bold">Theme: Dare to Dream</h3>
                </div>
              </div>
            </div>
            <CardContent className="p-6">
              <div className="flex items-center gap-4 mb-4 text-gray-600">
                ...
                <div className="flex items-center gap-2">
                  <MapPin className="h-4 w-4 text-ted-red" />
                  <span className="text-sm">Kigali High School</span>
                </div>
              </div>
              <p className="text-gray-600 mb-6">
              ...
              <Button className="w-full bg-ted-red hover:bg-ted-red/90 text-white">Learn More</Button>
            </CardContent>
          </Card>
        </div>
      </div>
