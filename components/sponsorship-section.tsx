        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {sponsorshipPackages.map((pkg, index) => (
              <Card
                key={index}
                className={`bg-black/40 backdrop-blur-sm border border-gray-800 overflow-hidden transition-all duration-500 hover:border-ted-red/50 hover:shadow-[0_0_15px_rgba(230,43,30,0.15)] ${index === 0 ? "md:transform md:-translate-y-4" : ""}`}
              >
