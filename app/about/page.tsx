        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              There are many ways to be part of the TEDx Kigali High School Youth experience.
            </p>
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="bg-black/40 backdrop-blur-sm border border-gray-800 rounded-xl p-6 hover:border-ted-red/50 transition-colors">
